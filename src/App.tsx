      ...
      <section className="bg-white shadow-sm">
        <div className="max-w-4xl mx-auto px-6 py-16 text-center">
          ...
          <p className="text-md text-gray-600 mb-8">
            ...
            <a href="https://api.whatsapp.com/send?phone=91XXXXXXXXXX&text=Hello%20I%20want%20to%20buy%20a%20Grade%206%20Maths%20practice%20test" target="_blank" className="inline-block px-6 py-3 bg-green-600 text-white rounded-2xl shadow hover:bg-green-700">Buy Practice Test on WhatsApp</a>
        </div>
      </section>
